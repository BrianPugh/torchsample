...
.. |GHA tests| image:: https://github.com/BrianPugh/package_name/workflows/tests/badge.svg
   :target: https://github.com/BrianPugh/package_name/actions?query=workflow%3Atests
   :alt: GHA Status
.. |Codecov report| image:: https://codecov.io/github/BrianPugh/package_name/coverage.svg?branch=master
   :target: https://codecov.io/github/BrianPugh/package_name?branch=master
   :alt: Coverage
