...
html_logo = "../assets/banner-white-bg-200w.png"
html_favicon = "../assets/logo-64w.png"
...
def auto_convert_readme(_):
    """Make symbolic links to README.rst at docs/source/readme.rst."""
    readme_path_rst = os.path.join(REPO_DIRECTORY, "README.rst")
    ...
    make_symlink(readme_path_rst, readme_path_output)
    make_symlink(
        os.path.join(REPO_DIRECTORY, "assets"),
        os.path.join(DOCS_DIRECTORY, "source", "assets"),
    )
